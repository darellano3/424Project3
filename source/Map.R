...
# m
  ...
  output$Map_nodes <- renderLeaflet({
    ...
    m = leaflet() %>%
      ...
      addMarkers(data = inteLocations, lng = ~latitude, lat = ~longitude, layerId = ~node_vsn,popup = ~node_vsn, group = "Light Intensity(default)") %>%
      addMarkers(data = humLocations, lng = ~latitude, lat = ~longitude, layerId = ~node_vsn,popup = ~node_vsn, group = "Humidity") %>%
      addMarkers(data = tempLocations, lng = ~latitude, lat = ~longitude, layerId = ~node_vsn,popup = ~node_vsn, group = "Temperature") %>%
      addMarkers(data = SO2Locations, lng = ~latitude, lat = ~longitude, layerId = ~node_vsn,popup = ~node_vsn, group = "SO2") %>%
      addMarkers(data = H2SLocations, lng = ~latitude, lat = ~longitude, layerId = ~node_vsn,popup = ~node_vsn, group = "H2S") %>%
      addMarkers(data = OzoneLocations, lng = ~latitude, lat = ~longitude, layerId = ~node_vsn,popup = ~node_vsn, group = "Ozone") %>%
      addMarkers(data = NO2Locations, lng = ~latitude, lat = ~longitude, layerId = ~node_vsn,popup = ~node_vsn, group = "NO2") %>%
      addMarkers(data = COLocations, lng = ~latitude, lat = ~longitude, layerId = ~node_vsn,popup = ~node_vsn, group = "CO") %>%
