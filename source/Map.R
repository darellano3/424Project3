...
output$graph <- renderPlotly({
  ...
  tempPastWeek <- subset(tempLocations, as.POSIXlt(tempLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(tempLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > pastWeekTimeObject & node_vsn == node_id)
  humPastWeek <- subset(humLocations, as.POSIXlt(humLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(humLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > pastWeekTimeObject & node_vsn == node_id)
  SO2PastWeek <- subset(SO2Locations, as.POSIXlt(SO2Locations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(SO2Locations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > pastWeekTimeObject & node_vsn == node_id)
  COPastWeek <- subset(COLocations, as.POSIXlt(COLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(COLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > pastWeekTimeObject & node_vsn == node_id)
  OzonePastWeek <- subset(OzoneLocations, as.POSIXlt(OzoneLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(OzoneLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > pastWeekTimeObject & node_vsn == node_id)
  intePastWeek <- subset(inteLocations, as.POSIXlt(inteLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(inteLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > pastWeekTimeObject & node_vsn == node_id)
  NO2PastWeek <- subset(NO2Locations, as.POSIXlt(NO2Locations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(NO2Locations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > pastWeekTimeObject & node_vsn == node_id)
  H2SPastWeek <- subset(H2SLocations, as.POSIXlt(H2SLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(H2SLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > pastWeekTimeObject & node_vsn == node_id)
  ...
  if (input$AOTSelect == 'current'){
    output$graph <- renderPlotly({
      ...
      output$graph <- renderPlotly({
        ...
        tempPast24 <- subset(tempLocations, as.POSIXlt(tempLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(tempLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > past24TimeObject & node_vsn == node_id)
        humPast24 <- subset(humLocations, as.POSIXlt(humLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(humLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > past24TimeObject & node_vsn == node_id)
        SO2Past24 <- subset(SO2Locations, as.POSIXlt(SO2Locations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(SO2Locations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > past24TimeObject & node_vsn == node_id)
        COPast24 <- subset(COLocations, as.POSIXlt(COLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(COLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > past24TimeObject & node_vsn == node_id)
        OzonePast24 <- subset(OzoneLocations, as.POSIXlt(OzoneLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(OzoneLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > past24TimeObject & node_vsn == node_id)
        intePast24 <- subset(inteLocations, as.POSIXlt(inteLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(inteLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > past24TimeObject & node_vsn == node_id)
        NO2Past24 <- subset(NO2Locations, as.POSIXlt(NO2Locations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(NO2Locations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > past24TimeObject & node_vsn == node_id)
        H2SPast24 <- subset(H2SLocations, as.POSIXlt(H2SLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) < as.POSIXlt(Sys.time(),tz = "GMT", "%Y-%m-%d %H:%M:%OS" ) & as.POSIXlt(H2SLocations[["timestamp"]], tz = "GMT", "%Y-%m-%dT%H:%M:%OS" ) > past24TimeObject & node_vsn == node_id)
