...
body<-dashboardBody(
              div(style = "font-size: 20px; padding: 5px 0px; margin:0%",
                    column(12,
                           box(title="Interactive Map of AOT Nodes",solidHeader = TRUE,status="primary",selectInput("Visualized_Element", "Select which element you would like to visualize", nodeInfoList, selected = "SO2"),
